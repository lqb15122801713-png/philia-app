...
const ROUTES = [
  ...
  { app: 'merchant', path: '/monitor', anchors: ['服务监视'], note: 'B2 修复路由' },
  { app: 'merchant', path: '/monitor/', anchors: ['服务监视'], note: '尾斜杠变体' },
  { app: 'merchant', path: `/monitor/${APPT_ID}`, anchors: ['监视', '预约'], serverDep: true, note: 'B2 别名深链' },
  { app: 'merchant', path: '/live', anchors: ['服务监视'], expectPath: '/monitor', note: 'B2 重定向' },
